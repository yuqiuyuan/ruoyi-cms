...
var touchFun = {
	...
	createSearchPage: function() {
		...
		var strInput =
			'<div class="header-searchInput"><form><input placeholder="搜索文档或关键词" type="search" autocomplete="off" class="search-input" baidusug="2" id="search" value="' +
			searchWord +
	...
	getSearchData: function() {
		...
		var searchListUrl = '../page/list.html'; //测试链接地址
		for (var i = 0; i < hot.length; i++) {
			aHot += '<a href=' + searchListUrl + '>' + hot[i] + '</a>';
		}
