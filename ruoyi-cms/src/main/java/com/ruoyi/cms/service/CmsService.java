...
//        if(list==null){
    List<Article> list = articleService.selectArticlesByArticleRegionType(ArticleRegionType.REGION_RECOMMEND);
...
//        }
  ...
  /**
   * 注意:这个获取banner是为了给pnews这个前台模版准备的，它需要直接获取banner配置的图片素材 不要和BlogController里面的混淆了
   */
